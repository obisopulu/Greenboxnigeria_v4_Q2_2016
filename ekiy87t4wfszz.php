...
extract($row);
echo "<span id='secondtext'>$labelName</span>"?><button id='demo' onclick="copyToClipboard(document.getElementById('demo').innerHTML)" style='font-size:0px; background:url(images/copy.jpg) center no-repeat; border:none; background-size:cover; width:20px; height:20px; cursor:pointer; background-color:#222; font-size:0px' title='copy file url'>http://www.gbngr.com/library.php?1=ekiy87t4wfszz.php?label=<?php $name = str_replace(' ', '+', $labelName); echo $name?></button>
</span>
</td></tr></table>
<!--            Head            -->
