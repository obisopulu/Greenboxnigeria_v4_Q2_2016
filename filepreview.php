...
<button title='Play' style='font-size:0px; background:url(images/mobplay.png) center no-repeat; border:none; background-size:cover; width:40px; height:40px; cursor:pointer; background-color:#222; font-size:0px' 
 ...
 <br/><br/>
        <button id='demo<?php echo $songID?>' onclick="copyToClipboard(document.getElementById('demo<?php echo $songID ?>').innerHTML, '<?php echo $songID ?>')"style='font-size:0px; background:url(images/mobcopy.png) center no-repeat; border:none; background-size:cover; width:40px; height:40px; cursor:pointer; background-color:#222; font-size:0px' title='copy file url'>http://www.gbngr.com/library.php?1=filepreview.php?songURL=<?php echo $songURL ?></button>
<br/><br/>
