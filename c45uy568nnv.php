...
<span id="secondtext">
&nbsp;<?php echo $activityName?><button id='demo' onclick="copyToClipboard(document.getElementById('demo').innerHTML)" style='font-size:0px; background:url(images/copy.jpg) center no-repeat; border:none; background-size:cover; width:20px; height:20px; cursor:pointer; background-color:#262626; font-size:0px' title='copy page url'>http://www.gbngr.com/library.php?1=c45uy568nnv.php?article=<?php $name = str_replace(' ', '+',  $activityName); echo $name?></button>
</span>
...
<button style='background-image:url( <?php if ($activityPic=='') {echo "images/gid.jpg";}else{echo"activitiesimg/$activityPic";}?>); background-position:center; background-repeat:no-repeat; background-size:contain; border:none; height:200px; width:200px; cursor: pointer; background-color:#262626'></button>
