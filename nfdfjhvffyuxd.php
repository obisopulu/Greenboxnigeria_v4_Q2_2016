...
*<input required type='text' class='search' name='name' value=''  placeholder="Name" style="background-color:#FFF; color:#222; width:100%"/><br/>
*<input type='text' class='search' name='contact'  placeholder="Email"  value='' style="background-color:#FFF; color:#222; width:100%"/><br/>
*<input required type='text' class='search' name='subject'  placeholder="Subject"  value='' style="background-color:#FFF; color:#222; width:100%"/><br/>
<tr><td>*<input type='text' class='search' name='details' required placeholder="Message" value='' style="background-color:#FFF; color:#222; width:100%"/></td></tr>
