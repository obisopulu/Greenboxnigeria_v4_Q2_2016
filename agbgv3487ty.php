...
*<input required type='text' class='search' name='name' value=''  placeholder="Name"  size="28" style="background-color:#EEE; color:#222"/>
*<input type='text' class='search' name='contact'  placeholder="Email"  value='' src="100" width="100%" size="29" style="background-color:#EEE; color:#222"/>
*<input required type="email" required class='search' name='subject'  placeholder="Subject"  value='' size="28" style="background-color:#EEE; color:#222"/>
<tr><td>*<input type='text' class='search' name='details' required placeholder="Message" value='' size="99" style="background-color:#EEE; color:#222"/></td></tr>
