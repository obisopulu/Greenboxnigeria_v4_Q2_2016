...
<td>
<span id="firsttext"><?php echo $personStageName ?><button id='demo' onclick="copyToClipboard(document.getElementById('demo').innerHTML)" style='font-size:0px; background:url(images/copy.jpg) center no-repeat; border:none; background-size:cover; width:20px; height:20px; cursor:pointer; background-color:#222; font-size:0px' title='copy file url'>http://www.gbngr.com/library.php?1=kvrghwi58y9o.php?person=<?php $name = str_replace(' ', '+', $personStageName); echo $name?></button></span>
...
if ($personPlaceOfOrigin != '')echo "<p id='details'>Genre: <b>$personPlaceOfOrigin</b></p>"; 
if ($personGenre != '')echo "<p id='details'>State of origin: <b>$personGenre</b></p>"; 
